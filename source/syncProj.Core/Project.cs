...
public class Project
{
    ...
    public static String getProjectGuid(String path)
    {
    ...
    public static Project LoadProject(Solution solution, String path, Project project = null, int loadLevel = 0)
    {
        if (project == null)
    ...
    /// <returns></returns>
    public static List<String> getSortedConfigurations(List<String> configurations, bool bX3264hasPriority, bool? b64HasPriority = true, bool bCompareConfigNameFirst = false)
    {
