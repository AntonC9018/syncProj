...
public class CsScript
{
    ...
    public static bool RunScript(String _path, bool bCompileOnly, bool bAllowThrow, out String errors, params String[] args)
    {
        errors = "";
...
#pragma warning restore 618
    ...
    public static CsScriptInfo getCsFileInfo(String csPath, bool bUseAbsolutePaths, List<String> exceptFiles = null)
    {
